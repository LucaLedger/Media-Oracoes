...
public class java11 {
	...
	private JTextPane initialize() {
		...
		frmOraes.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\lucap\\Downloads\\homem-orando-deitado-de-joelhos.png"));
	...
	public static void AudioAcerto(int Musica) {
		try {
		    ...
		    //.getAudioInputStream(new File("/home/celso/Oracoes/" + Musica + ".wav").getAbsoluteFile());
